      ...
      <section className="not-found">
        <div className="container">
          <div className="not-found-content">
            ...
            <p className="text">
              Don&#39;t worry, it&#39;s just a little spilled Coffee. Let us
              help you clean that up and find your way! Mop up the spill to
              reveal something underneath.
            </p>
