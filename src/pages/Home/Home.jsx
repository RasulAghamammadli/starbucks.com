      ...
      <div className="container">
        <div className="home-inner">
          ...
          <div className="home-card-section">
            <div className="content-side">
              <div className="content-in">
                ...
                <p className="text">
                  The protein-packed Turkey Bacon, Cheddar & Egg White Sandwich
                  is such a tasty way to power your day.
                </p>
                <Link to="/menu" className="btn">
                  Order now
                </Link>
          ...
          <div className="home-card-section">
            <div className="content-side">
              <div className="content-in">
                <h2 className="title">Relax with a refreshing delivery deal</h2>
                <p className="text">
          ...
          <div className="inner-bottom">
            <div className="content">
              *25% off your Starbucks order on Uber Eats from 4/8-4/14. Max
              discount of $7. Fees and taxes still apply. Menu limited. See the
              Uber Eats app for availability & restrictions.
            </div>
          </div>
        </div>
      </div>
