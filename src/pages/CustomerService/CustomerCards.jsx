            ...
            <div className="cards">
              <Link to="/rewards" className="card">
                ...
                <div className="topic-icon">
                  <svg viewBox="-32 0 90 90">
                    <path d="M8,15 L8.70769,17.1769 L11,17.1769 L9.13846,18.5308 L9.85385,20.7077 L8,19.3615 L6.13846,20.7077 L6.85385,18.5308 L5,17.1769 L7.29231,17.1769 L8,15 Z M14,3 L15.6247,7.25738 L20,7.25738 L16.5506,10.113 L17.7082,14.4353 L14,11.9386 L10.2918,14.4353 L11.4495,10.113 L8,7.25738 L12.3754,7.25738 L14,3 Z"></path>
                  </svg>
                </div>
                <p className="topic-title">Starbucks Rewards</p>
              </Link>
              <Link to="/gift-cards" className="card">
                <div className="card-fade"></div>
                <div className="topic-icon">
                  <svg viewBox="-32 0 90 90">
                ...
                <p className="topic-title">Starbucks Card</p>
              </Link>
              <Link to="/menu" className="card">
                ...
                <p className="topic-title">Mobile</p>
              </Link>
              <Link to="/find-store" className="card">
                <div className="card-fade"></div>
                <div className="topic-icon">
                  <svg viewBox="-32 0 90 90">
                    <path d="M20.2 9.6c-.883 0-1.6.718-1.6 1.6 0 .882.717 1.6 1.6 1.6.882 0 1.6-.718 1.6-1.6 0-.882-.718-1.6-1.6-1.6m0 4.2c-1.434 0-2.6-1.166-2.6-2.6 0-1.433 1.166-2.6 2.6-2.6 1.434 0 2.6 1.167 2.6 2.6 0 1.434-1.166 2.6-2.6 2.6M7.5 13.1h1.4v-1.3H7.5v1.3zm1.5 1H7.4c-.48 0-.9-.42-.9-.9v-1.5c0-.48.42-.9.9-.9H9c.48 0 .9.42.9.9v1.5c0 .53-.37.9-.9.9z"></path>
                    <path d="M19.9 7.416L9.372 8c-.276.016-.487.252-.472.528.016.275.24.483.527.47l7.073-.392V16.9h-.6v-5.4c0-.576-.524-1.1-1.1-1.1h-2.7c-.576 0-1.1.524-1.1 1.1v5.4H4V9.28l1.33-.08c.275-.017.485-.254.468-.53-.016-.275-.254-.48-.53-.47l-2.97.182v-.298L19.9 7.117v.3zM12 16.9v-5.396c.005-.035.068-.098.1-.104h2.695c.036.006.1.07.105.1v5.4H12zm8.173-10.8L2 7.1c-.373 0-.7.327-.7.7v.9c0 .372.326.7.728.7h.002L3 9.34v8.06c0 .277.223.5.5.5H17c.276 0 .5-.223.5-.5V8.55l2.7-.15c.373 0 .7-.327.7-.7v-.9c0-.373-.326-.7-.727-.7z"></path>
                  </svg>
                </div>
                <p className="topic-title">In Our Stores</p>
              </Link>
